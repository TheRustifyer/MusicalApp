notes = [
['C','C'],['C#','Db'],['D','D'],['D#','Eb'],['E','Fb'],['F','E#'],['F#','Gb'],['G','G'],['G#','Ab'],['A','A'],['A#','Bb'],['B','Cb']]


intervals = [
['1','1'],['#1','b2'],['2','2'],['#2','b3'],['3','b4'],['4','#3'],['#4','b5'],['5','5'],['#5','b6'],['6','6'],['#7','b7'],['7','7']]


escala_mayor = ['1','2','3','4','5','6','7']

escala_menor = ['1','2','b3','4','5','b6','b7']

escala_menor_armonica = ['1','2','b3','4','5','b6','7']

escala_pentatonica_mayor = ['1','2','3','5','6']

arpegio_aumentado = ['1','3','#5']

arpegio_menor = ['1','b3','5']
